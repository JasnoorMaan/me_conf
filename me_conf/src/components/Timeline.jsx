  ...
  return (
    <section className="py-16 px-4">
      <div className="min-w-[40vw] mx-auto">
        <h2 className="heading text-center mb-12">Important Dates</h2>
        ...
        <div className="relative">
          ...
          {timelineData.map((item, index) => (
            <div key={item.id} className="relative pb-6 last:mb-0">
              ...
              <div className="pl-16">
                <div className={`p-4 rounded-lg shadow-md border-l-4 ${
                  item.isHighlight 
                    ...
                    : 'bg-white border-l-conf-green-400 hover:shadow-lg'
                }`}>
                 ...
                 {/* Date Badge */}
                  ...
                  {/* Title */}
                  <h3 className={`normal-text font-semibold mb-2 ${
                  ...
                  {/* Description */}
                  <p className="normal-text text-gray-600">{item.description}</p>
              ...
              {index < timelineData.length - 1 && (
                <div className="absolute left-6 top-12 w-0.5 h-8 bg-gradient-to-b from-conf-green-400 to-conf-green-600 opacity-60"></div>
              )}
            </div>
          ))}
        </div>
